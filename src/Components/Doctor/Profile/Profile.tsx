...
lisencesNo: 'XYZ123456',
speclization: 'Cardiology',
department: 'Heart',
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="bg-primary-50 p-4 rounded-lg">
              ...
              {edit ? (
                ...
                <div className="text-gray-700 mt-1">{Doctor.dob}</div>
              )}
            </div>
            ...
            <div className="bg-primary-50 p-4 rounded-lg">
              ...
              {edit ? (
                ...
                <div className="text-gray-700 mt-1">{Doctor.phone}</div>
              )}
            </div>
            ...
            <div className="bg-primary-50 p-4 rounded-lg md:col-span-2">
              ...
              {edit ? (
                ...
                <div className="text-gray-700 mt-1">{Doctor.address}</div>
              )}
            </div>
            ...
            <div className="bg-primary-50 p-4 rounded-lg">
              ...
              {edit ? (
                <TextInput
                  ...
                  className="mt-2"
                  defaultValue={Doctor.lisencesNo}
                />
              ) : (
                <div className="text-gray-700 mt-1">{Doctor.lisencesNo}</div>
              )}
            </div>
            ...
            <div className="bg-primary-50 p-4 rounded-lg">
              ...
              {edit ? (
                <TextInput
                  ...
                  className="mt-2"
                  defaultValue={Doctor.speclization}
                />
              ) : (
                <div className="text-gray-700 mt-1">{Doctor.speclization}</div>
              )}
            </div>
