...
const links = [
  { name: 'Dashboard', url: '/patient/dashboard', icon: <IconLayoutGrid size={20} stroke={1.5}/> },
  { name: 'Patients', url: '/patient/profile', icon: <IconManFilled size={20} stroke={1.5}/> },
  { name: 'Appointments', url: '/patient/appointment', icon: <IconCalendarSearch size={20} stroke={1.5}/> },
  { name: 'Booking', url: '/patient/book', icon: <IconVaccine size={20} stroke={1.5}/> },
  { name: 'Settings', url: '/patient/settings', icon: <IconSettings size={20} stroke={1.5}/> },
]
